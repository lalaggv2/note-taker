...
class Notebook {
  //get notes()
    // inside of this fuctionyou're goinna want to read from the db.json file the contests od the json file will be displayed on the page to read a file - readFile() which is a part of the 'fs' package
